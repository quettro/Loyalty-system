...
from ...serializers import (ServiceCategoryNotSafeSerializer,
                            ServiceCategorySafeSerializer)


class ServiceCategoryViewSet(SerializersMixin, ModelViewSet):
    safe_serializer = ServiceCategorySafeSerializer
    not_safe_serializer = ServiceCategoryNotSafeSerializer
    ...
    def get_queryset(self):
        ...
        categories = ServiceCategory.objects.filter(**params)
